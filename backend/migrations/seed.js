...
const seedDatabase = async () => {
    try {
        ...
        const existingCompanies = await (0, database_1.query)('SELECT COUNT(*) FROM companies');
      ...
      `, [
            ...
            const managerPassword = await (0, auth_1.hashPassword)('manager123!');
            const employeePassword = await (0, auth_1.hashPassword)('employee123!');
            const users = [
                {
